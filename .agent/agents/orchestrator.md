...
model: inherit
skills: clean-code, parallel-agents, behavioral-modes, plan-writing, brainstorming, architecture, lint-and-validate, powershell-windows, bash-linux, context-mode
---
...
| `frontend-specialist` | Frontend & UI | React, Next.js, Tailwind, components — always load skill **`ui-ux-master`** for visual UI/UX |
