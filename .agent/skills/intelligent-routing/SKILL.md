...
| **UI Component**    | "button", "card", "layout", "style"        | `frontend-specialist` + skill `ui-ux-master` | ✅ YES       |
| **UI/UX Design**    | "landing", "redesign", "polish UI", "design system", "dashboard UI", "anti-slop" | `frontend-specialist` + **`ui-ux-master`** (+ workflow `/ui-ux-master`) | ✅ YES |
| **Marketing Strategy / Advice** | "marketing", "chiến lược marketing", "tư vấn bán hàng", "định vị", "phễu", "cold email", "ads", "seo", "giá cả" | `cmo-marketing` (kết hợp `product-marketing`, `marketing-plan`) | ✅ YES |
| **Marketing UI / CRO** | "landing page bán hàng", "tối ưu chuyển đổi", "trang bán hàng", "cro", "copywriting landing", "tăng conversion" | `cmo-marketing` + `frontend-specialist` (kết hợp `cro`, `copywriting`, `ui-ux-master`) | ✅ YES |
| **UI template / gợi ý** | "template", "gợi ý UI", "chọn giao diện", "hướng thiết kế", "layout nào" | `frontend-specialist` + **`/design-suggest`** + catalog `ui-ux-master` | ✅ YES |
| **Nuxt / Vue UI** | "nuxt ui", "UButton", "UDashboard", "@nuxt/ui" | `frontend-specialist` + **`nuxt-ui`** | ✅ YES |
| **Ant Design / antd** | "antd", "ant design", "ConfigProvider", "enterprise admin React" | `frontend-specialist` + **`ant-design`** | ✅ YES |
| **Mobile UI**       | "screen", "navigation", "touch", "gesture" | `mobile-developer` (+ `mobile-design`)      | ✅ YES       |
...
| **Frontend**    | component, react, vue, css, html, tailwind, landing, redesign, ui/ux | `frontend-specialist` + load `ui-ux-master` |
