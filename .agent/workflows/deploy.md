...
**KHÔNG được deploy nếu Thầy chưa test trên localhost!**
Nếu Thầy chưa nói "OK", "test xong", "lên thôi" hoặc tương tự → HỎI trước: "Thầy đã test trên localhost chưa ạ?"
...
🤖 Em code trên Local
   ↓
🧪 Thầy test localhost: /test start → http://localhost:3000
   ↓  (Thầy nói "OK" hoặc "test xong")
📤 /deploy
   ↓
